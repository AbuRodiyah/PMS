			...
			<div class="col-lg-12">
				...
				<div class="card">
					<div class="card-header">
						...
						<button class="btn btn-primary btn-sm btn-block col-md-2 float-right" type="button" id="new_payroll_btn"><span class="fa fa-plus"></span> Re-Run Payroll</button>
					</div>
					<div class="card-body">
						<div class="row">
							<div class="col-md-12">
						...
						<table id="table" class="table table-bordered table-striped">
							...
							<tbody>
								<?php
									...
									$payroll=$conn->query("SELECT p.*,concat(e.lastname,', ',e.firstname,' ',e.middlename) as ename, e.salary, e.employee_no FROM payroll_items p inner join employee e on e.id = p.employee_id 
									INNER join payroll pay on pay.id = p.payroll_id;") or die(mysqli_error());

					...
					<div class="card-body">
						<ul class="list-group">
						  ...
						  <li class="list-group-item d-flex justify-content-between align-items-center alist" data-id="<?php echo $row['id'] ?>">
						    ...
						    <button class="badge badge-danger badge-pill btn remove_allowance" type="button"  data-id="<?php echo $row['id'] ?>"><i class="fa fa-trash" title="Delete"></i></button>
						  </li>
						<?php endwhile; ?>
						</ul>
					</div>
					...
					<div class="card-body">
						<ul class="list-group">
						  ...
						  <li class="list-group-item d-flex justify-content-between align-items-center dlist" data-id="<?php echo $row['id'] ?>">
						    ...
						    <button class="badge badge-danger badge-pill btn remove_deduction" type="button"  data-id="<?php echo $row['id'] ?>"><i class="fa fa-trash" title="Delete"></i></button>
						  </li>
						<?php endwhile; ?>
						</ul>
					</div>

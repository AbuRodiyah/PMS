<?php include('db_connect.php');  include('./header.php'); include 'navbar.php'; ?>
						...
						<table id="table" class="table table-bordered table-striped">
							...
							<tbody>
								...
								<tr>
									...
									<td>
										<center>
										 <button class="btn btn-sm btn-outline-primary view_employee" data-id="<?php echo $row['id']?>" type="button"><i class="fa fa-eye" title="View"></i></button>
										 <button class="btn btn-sm btn-outline-primary edit_employee" data-id="<?php echo $row['id']?>" type="button"><i class="fa fa-edit" title="Edit"></i></button>
										<button class="btn btn-sm btn-outline-danger remove_employee" data-id="<?php echo $row['id']?>" type="button"><i class="fa fa-trash" title="Delete"></i></button>
										</center>
									</td>
								</tr>
								<?php
